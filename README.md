...
To test the generated site locally before pushing, you can spin up a web server
that simulates GitHub Pages:

```bash
make serve
```

This serves the `docs/` directory on [http://localhost:8000](http://localhost:8000).
